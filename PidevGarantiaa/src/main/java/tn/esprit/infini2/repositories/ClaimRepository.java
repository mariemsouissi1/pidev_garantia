...
public interface ClaimRepository extends CrudRepository<Claim, Long>{
	...
	@Query(value="SELECT * FROM Claim C WHERE C.customerClaim=:ca AND C.claim_visibility=true ",nativeQuery = true)
	public List<Claim> Retrieve_claim_par_idclient(@Param("ca")CustomerAccount customerClaim);
}
