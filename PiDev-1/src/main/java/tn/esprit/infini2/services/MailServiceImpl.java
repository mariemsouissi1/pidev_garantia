...
public class MailServiceImpl implements IMailService {
	...
	@Override
	public void sendWithAttachment(CustomerAccount customer,Agent agent,String attachement) throws MailException, MessagingException {
		...
		buf.append("<html>\n" + "  <head>\n" + "    <meta name=\"viewport\" content=\"width=device-width\" />\n"
				...
				+ "                        <p>Thanks.</p>\n"
				+ "                        <p>Have a good day! Garantia MICRO-INSURANCE Group.</p>\n"
				+ "                      </td>\n" + "                    </tr>\n" + "                  </table>\n"
				+ "                </td>\n" + "              </tr>\n" + "\n"
				...
				+ "                    <span class=\"apple-link\">Garantia MICRO-INSURANCE,El-ghazela, Tunisie</span>\n"
				+ "                  </td>\n" + "                </tr>\n" + "                <tr>\n"
