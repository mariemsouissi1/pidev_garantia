...
public class MailServiceLoanImpl implements IMailServiceLoan {
	...
	@Autowired
	public MailServiceLoanImpl(JavaMailSender javaMailSender) {
	...
	public void sendEmailNotifAgent(Agent agent,int nbrSimulation) throws MailException, MessagingException {
		...
		MimeMessage mimeMessage = javaMailSender.createMimeMessage();
			...
			buf.append("\"<html>\n" + "  <head>\n" + "    <meta name=\"viewport\" content=\"width=device-width\" />\n"
					...
					+  "								"+nbrSimulation+ " simulations are requested to you and already in progress!</p>\n"
					+ "								<br/>"
					+ "							<p>All the best.</p>\n"
					+ "                        <p>Thank you.</p>\n"
					+ "                        <p>Kind Regards !, Garantia MICRO-INSURANCE Group.</p>\n"
					+ "                      </td>\n" + "                    </tr>\n" + "                  </table>\n"
					+ "                </td>\n" + "              </tr>\n" + "\n"
	...
	public void sendEmailWithAttachment(CustomerAccount customer,Agent agent,String attch,long idLoan) throws MailException, MessagingException {
		...
		buf.append("\"<html>\n" + "  <head>\n" + "    <meta name=\"viewport\" content=\"width=device-width\" />\n"
				...
				+ "                    <tr>\n" + "                      <td>\n"
				+ "                        <p>Dear Mr/Miss "+agent.getFirstName()+" "+ agent.getLastName()+" ,\"</p>\n"
				+ "                        <p>You have a credit loan tequest .</p>\n"
				+ "                        <table role=\"presentation\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"btn btn-primary\">\n"
				+ "                          <tbody>\n" + "                            <tr>\n"
				+ "                              <td align=\"left\">\n"
				+ "                                <table role=\"presentation\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\n"
		...
		File file = new File("C:\\Estimation\\"+attch);
